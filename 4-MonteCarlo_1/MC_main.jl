...
@time XX, EE, PP, CV, je, jj, C_H, CV, CV2 = MC.metropolis_ST(N=500, T=0.1,
 rho=0.8, maxsteps=30000, fstep=1, Df=1/60)
...
@everywhere function parallelPV(rho, N, T, Tarray)
    ...
    XX, EE, PP, CV, je, jj, C_H, CV, CV2 = MC.metropolis_ST(N=N, T=T, rho=rho, maxsteps=20000, fstep=1, Df=1/70)
...
T = [0.005:0.005:0.15; 0.2:0.1:0.52]
N = 108
ρ = 1.0
V = N/ρ
